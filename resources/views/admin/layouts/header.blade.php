        ...
        <div class="flex flex-wrap items-center">
            <div class="flex flex-shrink md:w-1/3 justify-center md:justify-start text-white">
                <a href="/" aria-label="Home">
                    <span class="text-xl pl-2">&LeftArrow; Home</span>
                </a>
            </div>
            ...
            <div class="flex w-full pt-2 content-center justify-between md:w-1/3 md:justify-end">
                <ul class="list-reset flex justify-between flex-1 md:flex-none items-center">
                    <li class="flex-1 flex justify-end md:flex-none md:mr-3">
                        <div class="relative inline-block" x-data="{ open: false }">
                            <button @click="open = !open" class="drop-button text-white py-2 px-2"> <span
                            ...
                            <div id="myDropdown" @click.away="open = false"
                                class="dropdownlist absolute bg-gray-800 text-white right-0 mt-3 p-3 overflow-auto z-30" x-show="open" x-cloak>
                                <div x-data="{
                                    search: '',
                                    show_item(el) {
