<div class="w-full flex justify-center gap-x-2">
    ...
    <form action="{{ route($route, $obj->$field) }}" method="POST" x-on:submit.prevent="onDelete(event)" class="btn-delete"
        x-show="!editMode">
        @method('DELETE')
        @csrf
        <button
    ...
    @if (Request::is('admin/products*'))
        <a href="{{ route('products.show', $obj->slug) }}" target="_blank" title="View Product"
