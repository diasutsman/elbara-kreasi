    ...
    <div class="flex flex-wrap">
            ...
            <div class="bg-gradient-to-b from-pink-200 to-pink-100 border-b-4 border-pink-500 rounded-lg shadow-xl p-5">
                <div class="flex flex-row items-center">
                    <div class="flex-shrink pr-4">
                        <div class="rounded-full p-5 bg-pink-600 text-white">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-card-list w-4 h-4"
                                viewBox="0 0 16 16">
                                <path
                    ...
                    <div class="flex-1 text-right md:text-center">
                        ...
                        <p class="font-bold text-3xl">{{ $products->count() }} <span class="text-pink-500"><i
        ...
        <div class="w-full md:w-1/2 xl:w-1/3 p-6">
            ...
            <div
                ...
                <div class="flex flex-row items-center">
                    <div class="flex-shrink pr-4">
                        <div class="rounded-full p-5 bg-yellow-600 text-white">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-images w-4 h-4"
                                viewBox="0 0 16 16">
                    ...
                    <div class="flex-1 text-right md:text-center">
                        <h2 class="font-bold uppercase text-gray-600">Total Portfolios<span class="md:hidden"> of
                                Product</span></h2>
                        <p class="font-bold text-3xl">{{ $portfolios->count() }} <span class="text-yellow-600"><i
        ...
        <div class="w-full md:w-1/2 xl:w-1/3 p-6">
            ...
            <div class="bg-gradient-to-b from-blue-200 to-blue-100 border-b-4 border-blue-500 rounded-lg shadow-xl p-5">
                <div class="flex flex-row items-center">
                    <div class="flex-shrink pr-4">
                        <div class="rounded-full p-5 bg-blue-600 text-white">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-envelope w-4 h-4"
                                viewBox="0 0 16 16">
                                <path
                    ...
                    <div class="flex-1 text-right md:text-center">
                        ...
                        <form @submit.prevent="submit" x-data="{
                            ...
                            method="POST">
                            @csrf
                            <input class="w-full text-center focus-visible:outline-none bg-transparent font-bold text-xl"
        ...
        <div class="w-full md:w-1/2 xl:w-1/3 p-6">
            ...
            <div class="bg-gradient-to-b from-green-200 to-green-100 border-b-4 border-green-600 rounded-lg shadow-xl p-5">
                <div class="flex flex-row items-center">
                    <div class="flex-shrink pr-4">
                        <div class="rounded-full p-5 bg-green-600 text-white">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-whatsapp w-4 h-4"
                                viewBox="0 0 16 16">
                                <path
        ...
        <div class="w-full md:w-1/2 xl:w-1/3 p-6">
            ...
            <div
                ...
                <div class="flex flex-row items-center">
                    <div class="flex-shrink pr-4">
                        <div class="rounded-full p-5 bg-indigo-600 text-white">
